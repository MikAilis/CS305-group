...
class PeerProc:
    ...
    def start_peer(self):
        ...
        self.process = subprocess.Popen(cmd.split(" "), stdin=subprocess.PIPE,stdout=peer_stdout_file, stderr=peer_stdout_file,text=True, bufsize=1, universal_newlines=True)
